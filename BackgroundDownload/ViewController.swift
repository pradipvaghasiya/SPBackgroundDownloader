...
extension ViewController : SPBackgroundDownloaderDelegate{
    private func setupDownloads(){
        ...
        let item1 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5153.jpg",
            fileToSaveURLString: "/Downloads/1/AllPhotos/IMG_5153.jpg")
        let item2 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5154.jpg",
            fileToSaveURLString: "/Downloads/1/AllPhotos/IMG_5154.jpg")
        let item3 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5155.jpg",
            fileToSaveURLString: "/Downloads/1/AllPhotos/IMG_5155.jpg")
        let item4 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5159.jpg",
            fileToSaveURLString: "/Downloads/1/AllPhotos/IMG_5159.jpg")
        let item5 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5157.jpg",
            fileToSaveURLString: "/Downloads/1/AllPhotos/IMG_5157.jpg")
        let item6 = ItemToDownloadInBackground(urlString: "http://flashair.local/DCIM/IMG_5158.jpg",
